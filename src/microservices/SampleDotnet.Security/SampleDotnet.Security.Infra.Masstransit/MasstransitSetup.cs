...
using SampleDotnet.Security.Consumers;
    ...
    public class MasstransitSetup
    {
        public IServiceCollection Configure(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddMassTransit(config =>
            {
                ...
                config.AddConsumer<ValidateFraudConsumer>();                          
                ...
                config.UsingRabbitMq((context, cfg) =>
                {
                    ...
                    cfg.ReceiveEndpoint("validate-fraud", e =>
                    {
                        ...
                        e.ConfigureConsumer<ValidateFraudConsumer>(context);
                    });                    
                });
            });
